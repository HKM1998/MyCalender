...
public class LoginController {
	...
	@PostMapping
	public String login(HttpServletRequest request, HttpServletResponse response, @ModelAttribute LoginCommandDTO loginCommandDTO, Errors errors) {
		...
		try {
			...
			session.setAttribute("userId", userAuthInfoDTO.getUserId());
