		...
		<div class="row">
			...
			<div id="recordContainer" class="col position-relative">
				<div id="recordListHeader" class="justify-content-between d-flex mx-auto">
					...
					<span id="totalCount" class="flex-fill align-middle text-end justify-content-center fs-5 mx-4 mt-1">총 ${totalCount} 건</span>
							...
							<tfoot id="totalList">
								<c:forEach var="total" items="${totalRecords}">
									<tr>
										...
										<td class="text-end mx-1" colspan="1">${total.count} 건</td>
										<td class="text-end mx-1" colspan="2"><fmt:formatNumber value="${total.totalAmount}" pattern="#,###" />원</td>
									</tr>
								</c:forEach>
							</tfoot>
						</c:if>
