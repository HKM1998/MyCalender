...
public class UserRegistController {
	...
	@PostMapping
	public String addUser(@ModelAttribute UserRegistRequestDTO userRegistRequestDTO, Errors errors, Model m) {
		new UserRegistValidator().validate(userRegistRequestDTO, errors);
		if(errors.hasErrors())
			return "register/registForm";
