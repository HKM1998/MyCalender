...
public class AccountBookService {
    ...
    public AccountBookDTO getRecordsById(Long idx) {
        return accountBookDAO.findByIdx(idx);
    }

    public void updateRecord(AccountBookDTO updatedRecord) {
    	accountBookDAO.updateRecord(updatedRecord);
    }
